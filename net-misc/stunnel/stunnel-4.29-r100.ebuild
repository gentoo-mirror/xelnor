...
pkg_postinst() {
	...
	einfo "file named stunnel.INST.conf in /etc/stunnel/, and add a symlink	"
	einfo "from stunnel.INST to stunnel in /etc/init.d. Instruction \'pid=\' "
	einfo "from those files will be ignored."
}
